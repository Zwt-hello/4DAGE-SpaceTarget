...
此SDK中不包含空间目标数据，你需要使用支持的设备采集创建您自己的空间数据。请参阅[数据采集](https://www.4dkankan.com/#/developer/useCollection "数据采集")文档，以了解更多信息。
...
1. 点击**Add Database** 按钮，打开database下载UI面板
	...
	*如何获取数据？请参阅[数据采集](https://www.4dkankan.com/#/developer/useCollection "数据采集")
